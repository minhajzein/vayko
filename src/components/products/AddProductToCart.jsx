...
function AddProductToCart({ slug, variant, title }) {
	...
	return (
		<button
			...
			disabled={isLoading}
			className='bg-white rounded-full hidden text-xs md:text-sm hover:scale-105 items-center justify-center gap-2 duration-300  text-[#FE2B3E] w-[] border border-[#FE2B3E] p-2 shadow'
		>
			{isLoading ? (
