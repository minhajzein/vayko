...
function CategoryCard({ id }) {
	...
	return (
		...
		>
			<div className='rounded-full relative shadow-inner shadow-gray-400 duration-300 size-[75px] md:size-[130px]'>
				<img
			...
			<h1 className='text-black duration-300 md:font-semibold text-[12px] md:text-lg max-w-full md:truncate capitalize'>
